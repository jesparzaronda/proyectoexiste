<?php
/**
 * About Melissa widget.
 *
 * @package Melissa
 */

if ( ! class_exists( 'Melissa_About_Widget' ) ) {

	class Melissa_About_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Display an information about your site.', 'melissa' );
			$this->widget_id          = 'melissa_widget_about';
			$this->widget_name        = esc_html__( 'About Melissa', 'melissa' );
			$this->settings           = array(
				'title'          => array(
					'type'  => 'text',
					'value' => '',
				...
				'enable_tagline' => array(
					...
					'options' => array(
						'enable_tagline' => esc_html__( 'Enable Tagline:', 'melissa' ),
					),
				),
				'content'        => array(
					'type'              => 'textarea',
					'placeholder'       => esc_html__( 'Text or HTML', 'melissa' ),
					'value'             => '',
					'label'             => esc_html__( 'Content:', 'melissa' ),
		...
		public function widget( $args, $instance ) {
			...
			if ( $tagline_enabled ) {
				$format   = apply_filters( 'melissa_about_widget_tagline_format', '<p>%s</p>', $this->settings, $this->args );
...
add_action( 'widgets_init', 'melissa_register_about_widget' );
function melissa_register_about_widget() {
	register_widget( 'Melissa_About_Widget' );
}
