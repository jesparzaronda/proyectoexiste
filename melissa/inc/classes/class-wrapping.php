 ...
 */
add_filter( 'template_include', array( 'Melissa_Wrapping', 'wrap' ), 99 );
add_filter( 'melissa_wrap_base', 'melissa_wrap_base_cpts' );
 ...
 */
function melissa_template_path() {
	return Melissa_Wrapping::$main_template;
}
 ...
 */
function melissa_template_base() {
	return Melissa_Wrapping::$base;
}

if ( ! class_exists( 'Melissa_Wrapping' ) ) {
	...
	class Melissa_Wrapping {
		...
		/**
		 * Initialize new instance of Melissa_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'melissa_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Melissa_Wrapping class.
		 *
		 * @since 1.0.0
		 *
 ...
 */
function melissa_wrap_base_cpts( $templates ) {
