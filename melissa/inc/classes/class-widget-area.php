...
if ( ! class_exists( 'Melissa_Widget_Area' ) ) {

	class Melissa_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'melissa_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'melissa_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'melissa_widget_area_classes', $classes, $area_id );
	...
	function melissa_widget_area() {
		return Melissa_Widget_Area::get_instance();
	}
