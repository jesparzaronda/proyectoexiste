...
function melissa_main_menu() {
	...
	<nav id="site-navigation" class="main-navigation" role="navigation">
		<button class="menu-toggle" aria-controls="main-menu" aria-expanded="false">
            ...
            <span>
                <?php echo esc_html__( 'Menu', 'melissa' ) ?>
            </span>
		</button>
		<?php
		$args = apply_filters( 'melissa_main_menu_args', array(
			'theme_location'   => 'main',
			'container'        => '',
			'menu_id'          => 'main-menu',
			'fallback_cb'      => 'melissa_set_nav_menu',
			'fallback_message' => esc_html__( 'Set main menu', 'melissa' ),
		) );
...
function melissa_footer_menu() { ?>
	<nav id="footer-navigation" class="footer-menu" role="navigation">
		<?php
		$args = apply_filters( 'melissa_footer_menu_args', array(
			...
			'fallback_message' => esc_html__( 'Set footer menu', 'melissa' ),
		) );
 ...
 * @return string
 */
function melissa_get_social_list( $context, $type = 'icon' ) {
	static $instance = 0;
	$instance ++;
	...
	$args = apply_filters( 'melissa_social_list_args', array(
		...
		'echo'             => false,
		'fallback_cb'      => 'melissa_set_nav_menu',
		'fallback_message' => esc_html__( 'Set social menu', 'melissa' ),
	), $context, $type );
 ...
 * @return void
 */
function melissa_set_nav_menu( $args ) {
