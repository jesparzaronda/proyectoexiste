(function ($) {
    ...
    CherryJsCore.theme_script = {
        ...
        smart_slider_init: function (self) {
            $('.melissa-smartslider').each(function () {
                var slider = $(this),
        ...
        swiper_carousel_init: function (self) {
            ...
            jQuery('.melissa-carousel').each(function () {
                var swiper = null,
        ...
        subscribe_init: function (self) {
            CherryJsCore.variable.$document.on('click', '.subscribe-block__submit', function (event) {
                ...
                var $this = $(this),
                    ...
                    nonce = form.find('input[name="melissa_subscribe"]').val(),
        ...
        main_menu: function (self, target) {
            ...
            if ('undefined' !== typeof melissa &&
                'undefined' !== typeof melissa.labels &&
                'undefined' !== typeof melissa.labels['hidden_menu_items_title'] &&
                '' !== melissa.labels.hidden_menu_items_title) {
                moreButtonText = melissa.labels.hidden_menu_items_title;
            }
        ...
        to_top_init: function (self) {
            if ($.isFunction(jQuery.fn.UItoTop)) {
                $().UItoTop({
                    text: melissa.labels.totop_button,
                    scrollSpeed: 600
                });
            }
        },
